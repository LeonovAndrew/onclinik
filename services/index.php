...
$APPLICATION->SetPageProperty("title", "Услуги и направления");
...
?>
    ...
    <section class="costsection">
        <div class="container">
            ...
            <div id="services-wrap">
				...
				<div class="costsection-radio-wrap mobile-radio-wrap">
					<label class="costsection-label">
						<span data-tab="directions" class="active">Направления</span>
					</label>
					<label class="costsection-label">
						<span data-tab="services">Услуги</span>
					</label>
                </div>
	...
	false
					...
					<?if(count($arDirectionsFilter['ID'])>24 || count($arServicesFilter['ID'])>72):?>
						<div class="administration-btn-wrap">
							...
							<input id="direction_all" value="<?=ceil(count($arDirectionsFilter['ID']) / 24)?>" type="hidden">
							<input id="services_all" value="<?=ceil(count($arServicesFilter['ID']) / 72)?>" type="hidden">
