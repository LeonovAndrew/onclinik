...
$APPLICATION->SetPageProperty("TITLE", "Соглашение о персональных данных. ММЦ ОН КЛИНИК");
$APPLICATION->SetPageProperty("description", "ММЦ ОН КЛИНИК: Соглашение о персональных данных");

$APPLICATION->SetTitle("Соглашение о персональных данных");
?>
