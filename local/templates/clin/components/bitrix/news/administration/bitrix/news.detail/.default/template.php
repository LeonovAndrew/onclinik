...
$this->setViewTarget('offers');
    if (!empty($arResult['OFFERS'])) {
        ...
        <div class="doctor-cost" id="prices">
            <h2><?php echo getMessage('PRICE');?></h2>
                    ...
                    <li>
                        <div class="action-programs-item-wrap">
                            ...
                            if ($obOffer->price != $obOffer->discountPrice) {
                                ?>
                                <b><?php echo getMessage('PRICE_FROM');?> <?php echo priceFormat($obOffer->discountPrice);?> ₽</b>
                                <span><?php echo getMessage('PRICE_FROM');?> <?php echo priceFormat($obOffer->price);?> ₽</span>
                                <?php
                            } else {
                                ?>
                                <b><?php echo getMessage('PRICE_FROM');?> <?php echo priceFormat($obOffer->price);?> ₽</b>
                                <?php
                            }
                            ?>
                        </div>
