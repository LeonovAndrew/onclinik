...
foreach ($arResult['ITEMS'] as &$arItem) {
     ...
     * modify url
     */
    $obDoctor = new Personal($arItem['ID']);
    $obDoctor->administrator = $arItem['PROPERTIES']['ADMINISTRATOR']['VALUE'];
    $obDoctor->url = $arItem['DETAIL_PAGE_URL'];
    $obDoctor->makeUrl();
    $arItem['DETAIL_PAGE_URL'] = $obDoctor->url;
}