...
<div class="certificates-filter">
    <form id="<?echo $arResult["FILTER_NAME"] . "_form"?>" class="certificates-select-wrap" name="<?echo $arResult["FILTER_NAME"] . "_form"?>" action="<?echo $arResult["FORM_ACTION"];?>" method="get">
        <?php
