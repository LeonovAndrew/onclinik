	...
	<div class="container">
		<div class="jobs-container">
			...
			<div class="jobs-wrap2">
                ...
                <div class="jobs-text-container1">
                    <?php
                    $APPLICATION->IncludeFile(
                        SITE_DIR . "/include/jobs/preview_text.php",
                        array(),
                        array(
                            "MODE" => "html",
                            "NAME" => "Текст анонса",
                ...
                <div class="jobs-text-container2">
                    <?php
                    $APPLICATION->IncludeFile(
                        SITE_DIR . "/include/jobs/detail_text.php",
                        array(),
                        array(
                            "MODE" => "html",
