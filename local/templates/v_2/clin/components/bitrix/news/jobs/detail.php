    ...
    <div class="container">
        <div class="vacancy-container">
            ...
            <div class="vacancy-wrap2">
                ...
                $vacancyId = $APPLICATION->IncludeComponent(
                    'bitrix:news.detail',
                    '',
                    array(
                ...
                $APPLICATION->IncludeComponent(
                    ...
                    '',
                    array(
                        'IBLOCK_ID' => VacancyApplication::getIBlockId(),
                        'EVENT_NAME' => 'VACANCY_FORM',
						'EVENT_MESSAGE_ID' => Array(102,103),
