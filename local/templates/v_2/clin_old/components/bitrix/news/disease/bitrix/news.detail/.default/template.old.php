...
<div class="service1-tabs">
    ...
    <div class="service1-tabs-wrap">
        ...
        if (!empty($arResult['BOTTOM_TABS']['SYMPTOMS'])) {
            ?>
            <div class="service1-tab block_content" id="symptoms">
                <div class="service1-tab-wrap">
                    <?php echo $arResult['BOTTOM_TABS']['SYMPTOMS']['preview_text'];?>
                    <?php
                    $k = 0;
                    $pageSize = 6;
                    ...
                    <div class="service1-tab-link-wrap">
                        <a href="<?php echo getMessage('all_symptoms_link');?>"><?php echo getMessage('all_symptoms');?></a>
                    </div>
                    <div class="service1-tab-text1">
                        <?php echo $arResult['BOTTOM_TABS']['SYMPTOMS']['detail_text'];?>
                    </div>
                </div>
            </div>
            <?php
                    ...
                    <div class="cost1">
                        <ul class="cost1-list">
                            ...
                            foreach ($arService['items'] as $obService) {
                                ?>
                                <li>
                                    <a href="<?=$obService->url?>"><?php echo $obService->name;?></a>
                                    <?php
